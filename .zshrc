...
function ff() { find . -type f -iname "$1" ${@:2} }
...
function customClearScreen() {
  echo "\ec\e[3J"; zle reset-prompt; # For TMUX
  echoti clear; precmd; zle redisplay; # For ZSH Shell
}
...
# VS Code
alias code.='code .'
alias codezsh="code ~/.zshenv"
alias codezshenv="code ~/.zshenv && code ~/.zshrc"
...
alias npmrwt='npm run watch-test'
alias npmrc='npm run coverage'
alias npmrwc='npm run watch-coverage'
...
alias npmrwds='npm run webpack-dev-server'
